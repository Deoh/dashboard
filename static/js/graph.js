...
function show_disciplin_selector(ndx) {
...
function show_average_salary(ndx) {
    ...
    dc.barChart("#average-salary")
        ...
        .margins({ top: 10, right: 50, bottom: 30, left: 50 })
        .dimension(dim)
        .group(averageSalaryByGender) //because a custom reducer was used(.reduce()) we need to use .valueAccessor()
        .valueAccessor(function(d) {
